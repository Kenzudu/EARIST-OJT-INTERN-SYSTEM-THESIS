...
function StudentAttendance() {
    ...
    const REQUIRED_HOURS = 300; // Total required hours
    ...
    const remainingHours = Math.max(0, REQUIRED_HOURS - totalHours);
    const progressPercentage = Math.min(100, (totalHours / REQUIRED_HOURS) * 100);
        ...
        <div className="admin-dashboard-container">
            <div className="admin-dashboard-main">
                ...
                {loading ? (
                    ...
                    {/* Styled Attendance Table CORRECTED */ }
