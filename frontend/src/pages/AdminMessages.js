...
function AdminMessages() {
    ...
    const fetchUsers = async () => {
        try {
            ...
            // Filter to show coordinators and supervisors
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            await axios.post(`${baseURL}admin/messages/`, formData, {
                headers: {
    ...
    const handleSendChatMessage = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${baseURL}admin/messages/`, formData, {
                headers: {
                    Authorization: `Token ${token}`,
                    'Content-Type': 'multipart/form-data'
                }
    ...
    const markAsRead = async (messageId) => {
        try {
            const token = localStorage.getItem('token');
            await axios.put(`${baseURL}admin/messages/${messageId}/read/`, {}, {
                headers: { Authorization: `Token ${token}` }
            });
            fetchMessages();
        } catch (err) {
    ...
    const handleDeleteMessage = async (messageId, e) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`${baseURL}admin/messages/${messageId}/`, {
                headers: { Authorization: `Token ${token}` }
            });
    ...
    const handleDeleteAll = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${baseURL}admin/messages/delete-all/`, {}, {
                headers: { Authorization: `Token ${token}` }
            });
    ...
    const handleDeleteConversation = async () => {
        ...
        try {
            ...
            const deletePromises = chatMessages.map(msg =>
                axios.delete(`${baseURL}admin/messages/${msg.id}/`, {
                    headers: { Authorization: `Token ${token}` }
                })
            );
    ...
    return (
        <div className="admin-dashboard-container">
            ...
            <div className="admin-dashboard-main">
                <AdminHeader
                    title="Messages"
                    subtitle="Communicate with coordinators and supervisors"
                />
                    ...
                    <div className="messages-container">
                        {loading ? (
                            ...
                            <div className="empty-state">
                                ...
                                <p>Start a conversation with coordinators or supervisors</p>
                            </div>
                        ) : (
                            ...
                            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                ...
                                <form onSubmit={handleSendMessage} className="compose-form">
                                    <div className="form-group">
                                        ...
                                        >
                                            <option value="">Choose a coordinator or supervisor...</option>
                                            {users.map(user => (
