                                ...
                                {filteredNotifications.map(notification => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            borderLeft: `4px solid ${notification.read ? '#e0e0e0' : (notification.type === 'info' ? '#17a2b8' : '#007bff')}`,
                                            borderRadius: '8px',
                                            padding: '16px 20px',
                                            cursor: 'pointer',
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            height: '40px',
                                            borderRadius: '50%',
                                            background: notification.read ? '#e9ecef' : (notification.type === 'info' ? '#d1ecf1' : '#d1ecf1'),
                                            display: 'flex',
                                            alignItems: 'center',
                                            justifyContent: 'center',
                                            fontSize: '20px',
                                            flexShrink: 0,
                                            color: notification.type === 'info' ? '#0c5460' : 'inherit'
                                        }}>
                                        ...
                                        {!notification.read && (
                                            <div style={{
                                                ...
                                                height: '8px',
                                                borderRadius: '50%',
                                                background: notification.type === 'info' ? '#17a2b8' : '#007bff',
                                                flexShrink: 0,
                                                marginTop: '6px'
                                            }} />
                                        )}
